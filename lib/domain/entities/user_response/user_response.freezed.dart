...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<User> users, ResponseInfo info});
...
class _$_UserResponse implements _UserResponse {
  const _$_UserResponse({required final List<User> users, required this.info})
      : _users = users;
  ...
  @override
  String toString() {
    return 'UserResponse(users: $users, info: $info)';
  }
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse(
      ...
      required final ResponseInfo info}) = _$_UserResponse;
