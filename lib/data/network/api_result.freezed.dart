...
/// @nodoc
abstract class _$$ApiResultSuccessCopyWith<T, $Res> {
  factory _$$ApiResultSuccessCopyWith(_$ApiResultSuccess<T> value,
          $Res Function(_$ApiResultSuccess<T>) then) =
      __$$ApiResultSuccessCopyWithImpl<T, $Res>;
  @useResult
  $Res call({T data});
}

/// @nodoc
class __$$ApiResultSuccessCopyWithImpl<T, $Res>
    extends _$ApiResultCopyWithImpl<T, $Res, _$ApiResultSuccess<T>>
    implements _$$ApiResultSuccessCopyWith<T, $Res> {
  __$$ApiResultSuccessCopyWithImpl(
      _$ApiResultSuccess<T> _value, $Res Function(_$ApiResultSuccess<T>) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ApiResultSuccess<T>(
      freezed == data
          ? _value.data
...
class _$ApiResultSuccess<T> implements ApiResultSuccess<T> {
  const _$ApiResultSuccess(this.data);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ApiResultSuccessCopyWith<T, _$ApiResultSuccess<T>> get copyWith =>
      __$$ApiResultSuccessCopyWithImpl<T, _$ApiResultSuccess<T>>(
          this, _$identity);
...
abstract class ApiResultSuccess<T> implements ApiResult<T> {
  const factory ApiResultSuccess(final T data) = _$ApiResultSuccess<T>;
...
class __$$ApiResultErrorCopyWithImpl<T, $Res>
    extends _$ApiResultCopyWithImpl<T, $Res, _$ApiResultError<T>>
...
class _$ApiResultError<T> implements ApiResultError<T> {
  const _$ApiResultError(this.error);
...
abstract class ApiResultError<T> implements ApiResult<T> {
  const factory ApiResultError(final NetworkException error) =
      _$ApiResultError<T>;
