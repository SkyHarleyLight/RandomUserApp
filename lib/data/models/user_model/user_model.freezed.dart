...
abstract class $UserModelCopyWith<$Res> {
  ...
  $Res call(
      {String gender,
      @JsonKey(name: 'name') PersonalInfoModel personalInfo,
...
class _$_UserModel implements _UserModel {
  const _$_UserModel(
      ...
      @JsonKey(name: 'name') required this.personalInfo,
  ...
  @override
  String toString() {
    return 'UserModel(gender: $gender, personalInfo: $personalInfo, location: $location, email: $email, phone: $phone)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      @JsonKey(name: 'name') required final PersonalInfoModel personalInfo,
